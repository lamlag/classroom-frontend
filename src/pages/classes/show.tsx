  ...
  if (isLoading || isError || !classDetails) {
    return <ShowView className="class-view class-show">
      ...
      <p className="state-message">
        {isLoading ? "Loading class details..." : isError ? "Error: Failed to load class details" : "Class details not found"}
      </p>
    </ShowView>;
  }
  ...
  return (
    <ShowView className="class-view class-show">
      ...
      <div className="banner">
        {bannerUrl ? <AdvancedImage alt="Class Banner" cldImg={bannerPhoto(bannerCldPubId ?? '', name)}/> :
