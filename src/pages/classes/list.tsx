  ...
  const classColumns = useMemo<ColumnDef<ClassDetails>[]>(() => [
      {
        ...
        cell: ({getValue}) => {
          ...
          return url ? (
            ...
            <div
              className="ml-2 w-12 h-12 rounded bg-muted flex items-center justify-center text-[10px] text-muted-foreground text-center">
              No Image
            </div>
          );
        },
      ...
      },
      {
        ...
        header: () => <p className="column-title text-center">Capacity</p>,
        cell: ({getValue}) =>
          <p className="text-foreground text-center">{getValue<number>()}</p>,
      },
    ],
    [],
  );
